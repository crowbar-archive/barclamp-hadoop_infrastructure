...
# Recipe: hadoop_infrastructure_controller.rb
#
...
class HadoopInfrastructureController < BarclampController
  def initialize
    @service_object = HadoopInfrastructureService.new logger
    @hadoop_config = {
      :adminnodes => [],
      :servernodes => [],
      :namenodes => [],
